...
declare module "@_koii/web3.js" {
   ...
   */
  declare export var ATTENTION_CONFIG_ID: PublicKey;

  /**
   * An enumeration of valid StakeInstructionType's
   */
  declare export type AttentionInstructionType =
    | "RegisterRecipient"
    | "SubmitPorts";
  declare export type WithdrawStakeParams$1 = {
   ...
   */
  declare export class AttentionProgram {
    /**
     ...
     */
    static withdraw(params: WithdrawStakeParams$1): Transaction;
    static addFunds(params: WithdrawStakeParams$1): Transaction;
  ...
  declare export type CustomFetch = (
  ...
  declare export type TaskState<T> = {
    data: T,
    ...
  };
  declare export type TaskStateRound = {
    data: any,
    ...
  };
 ...
 */
     ...
     */
    getMyTaskSubmissionRoundInfoAndContext(
      publicKey: PublicKey,
     ...
     * Fetch all the Task distribution info for the specified public key, return with context
     */
    getTaskDistributionInfoAndContext(
      publicKey: PublicKey,
      round?: number,
      encoding?: "jsonParsed" | "base64" | "base64+zstd",
      commitment?: Commitment
     ...
     */
    getTaskSubmissionInfoAndContext(
      publicKey: PublicKey,
      round?: number,
      encoding?: "jsonParsed" | "base64" | "base64+zstd",
      commitment?: Commitment
 ...
 */
    ...
    isNumber(value: number | void): boolean;
  }
