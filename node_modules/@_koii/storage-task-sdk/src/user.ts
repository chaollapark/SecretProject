...
import {KoiiStorageClient} from './index';

const koiiClient = new KoiiStorageClient(undefined, undefined, true);
async function main() {
  let x = new Keypair();
  let data = await koiiClient.uploadFile('/home/ghazanfer/Downloads/task(79).log', x);
  console.log(data);
